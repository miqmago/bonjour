...
Registry.prototype.publish = function (opts) {
  ...
  service.start({
    ...
    reannounceDelay: opts.reannounceDelay || 1000,
    reannounceForever: opts.reannounceForever || false,
...
function announce (server, service, opts) {
  var delay = opts.reannounceDelay
  ...
  ;(function broadcast () {
    ...
    server.mdns.respond(packet, function () {
      ...
      if ((delay < opts.reannounceMaxMs || opts.reannounceForever) && !service._destroyed) {
